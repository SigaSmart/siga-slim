 ...
 */
class Files extends Tags {

    protected $tagLabel = '<label class="label"><span class="legend">%s</span><input multiple="true" type="file[]" name="%s" %s></label>';
    protected $tag = '<input multiple="true" type="file[]" name="%s" %s>';
    protected $ignores = [
        '1' => 'value_options',
        '2' => 'value_empty',
        '3' => 'rows',
